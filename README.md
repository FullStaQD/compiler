...
If you prefer to build outside the container, you need LLVM/MLIR >= VERSION_USED_BY_DEVCONTAINER installed. If you have no previous installation, check the guide [here](https://mqt.readthedocs.io/projects/core/en/latest/installation.html#setting-up-mlir).
