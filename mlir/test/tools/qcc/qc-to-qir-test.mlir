...
// CHECK-LABEL:   llvm.func @main() -> i64 attributes
// CHECK:           %[[NULL:.*]] = llvm.mlir.zero : !llvm.ptr
// CHECK:           %[[ZERO:.*]] = llvm.mlir.constant(0 : i64) : i64
// CHECK:           llvm.call @__quantum__rt__initialize(%[[NULL]]) : (!llvm.ptr) -> ()
// CHECK:           %[[QUBIT:.*]] = llvm.inttoptr %[[ZERO]] : i64 to !llvm.ptr
// CHECK:           llvm.call @__quantum__qis__x__body(%[[QUBIT]]) : (!llvm.ptr) -> ()
