...
// CHECK-DAG:     %[[UNDEF_VEC:.*]] = llvm.mlir.undef : vector<[8]xi8>
// CHECK:         %[[VEC0:.*]] = llvm.insertelement %[[IDX0]], %[[UNDEF_VEC]][%[[ZERO]] : i32] : vector<[8]xi8>
// CHECK:         llvm.call_intrinsic "llvm.riscv.qv.h"(%[[VEC0]], %[[ZERO]], %[[ZERO]], %[[ONE]])
// CHECK:         %[[VEC1:.*]] = llvm.insertelement %[[IDX1]], %[[UNDEF_VEC]][%[[ZERO]] : i32] : vector<[8]xi8>
...
// CHECK-DAG:     %[[ONE:.*]] = llvm.mlir.constant(1 : i32) : i32
// CHECK-DAG:     %[[UNDEF_VEC:.*]] = llvm.mlir.undef : vector<[8]xi8>
// CHECK:         %[[CVEC:.*]] = llvm.insertelement %[[CIDX]], %[[UNDEF_VEC]][%[[ZERO]] : i32] : vector<[8]xi8>
...
// CHECK:         %[[VEC:.*]] = llvm.insertelement %[[IDX]], %[[UNDEF_VEC]][%[[ZERO]] : i32] : vector<[8]xi8>
