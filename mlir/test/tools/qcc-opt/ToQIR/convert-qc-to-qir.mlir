...
// CHECK-LABEL:  func.func @test_memref_lowering() -> i64 attributes {passthrough = ["entry_point", ["output_labeling_schema", "schema_id"], ["qir_profiles", "adaptive_profile"], ["required_num_qubits", "0"], ["required_num_results", "0"]], qcc.entry_point} {
...
func.func @test_lowering_of_structured_output_recording(%ref: memref<3xi64>) -> i64 attributes { qcc.entry_point } {
    // CHECK-LABEL:   func.func @test_lowering_of_structured_output_recording(%arg0: memref<3xi64>) -> i64 attributes {
