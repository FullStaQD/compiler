...
int main(int argc, char** argv) {
  ...
  registry.insert<mlir::func::FuncDialect, mlir::arith::ArithDialect, mlir::tensor::TensorDialect,
                  ...
                  mlir::cf::ControlFlowDialect, jasp::JaspDialect, mlir::qc::QCDialect>();
  mlir::stablehlo::registerAllDialects(registry);
  qcc::registerJaspToQC();
  mlir::stablehlo::registerStablehloLegalizeToLinalgPass();
  // mlir::stablehlo::registerStablehloLegalizeToTosaPass();
  ...
  mlir::bufferization::registerOwnershipBasedBufferDeallocationPass();
